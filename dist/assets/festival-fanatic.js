...
define("festival-fanatic/genre/classic/template", ["exports"], function (exports) {
  exports["default"] = Ember.HTMLBars.template({ "id": "WP5Zc7OK", "block": "{\"statements\":[[\"open-element\",\"div\",[]],[\"static-attr\",\"class\",\"genre-template classic-background\"],[\"flush-element\"],[\"text\",\"\\n\"],[\"close-element\"],[\"text\",\"\\n\"]],\"locals\":[],\"named\":[],\"yields\":[],\"blocks\":[],\"hasPartials\":false}", "meta": { "moduleName": "festival-fanatic/genre/classic/template.hbs" } });
});
...
define("festival-fanatic/genre/country/template", ["exports"], function (exports) {
  exports["default"] = Ember.HTMLBars.template({ "id": "IpJ+Ymws", "block": "{\"statements\":[[\"open-element\",\"div\",[]],[\"static-attr\",\"class\",\"genre-template country-background\"],[\"flush-element\"],[\"text\",\"\\n\"],[\"close-element\"],[\"text\",\"\\n\"]],\"locals\":[],\"named\":[],\"yields\":[],\"blocks\":[],\"hasPartials\":false}", "meta": { "moduleName": "festival-fanatic/genre/country/template.hbs" } });
});
...
define("festival-fanatic/genre/edm/template", ["exports"], function (exports) {
  exports["default"] = Ember.HTMLBars.template({ "id": "gmppCV57", "block": "{\"statements\":[[\"open-element\",\"div\",[]],[\"static-attr\",\"class\",\"genre-template edm-background\"],[\"flush-element\"],[\"text\",\"\\n\"],[\"close-element\"],[\"text\",\"\\n\"]],\"locals\":[],\"named\":[],\"yields\":[],\"blocks\":[],\"hasPartials\":false}", "meta": { "moduleName": "festival-fanatic/genre/edm/template.hbs" } });
});
...
define("festival-fanatic/genre/jazz/template", ["exports"], function (exports) {
  exports["default"] = Ember.HTMLBars.template({ "id": "slll+VjO", "block": "{\"statements\":[[\"open-element\",\"div\",[]],[\"static-attr\",\"class\",\"genre-template jazz-background\"],[\"flush-element\"],[\"text\",\"\\n\"],[\"close-element\"],[\"text\",\"\\n\"]],\"locals\":[],\"named\":[],\"yields\":[],\"blocks\":[],\"hasPartials\":false}", "meta": { "moduleName": "festival-fanatic/genre/jazz/template.hbs" } });
});
...
define("festival-fanatic/genre/rap/template", ["exports"], function (exports) {
  exports["default"] = Ember.HTMLBars.template({ "id": "RIxQWgJY", "block": "{\"statements\":[[\"open-element\",\"div\",[]],[\"static-attr\",\"class\",\"genre-template rap-background\"],[\"flush-element\"],[\"text\",\"\\n\"],[\"close-element\"],[\"text\",\"\\n\"]],\"locals\":[],\"named\":[],\"yields\":[],\"blocks\":[],\"hasPartials\":false}", "meta": { "moduleName": "festival-fanatic/genre/rap/template.hbs" } });
});
...
define("festival-fanatic/genre/rock/template", ["exports"], function (exports) {
  exports["default"] = Ember.HTMLBars.template({ "id": "75xZCsAh", "block": "{\"statements\":[[\"open-element\",\"div\",[]],[\"static-attr\",\"class\",\"genre-template rock-background\"],[\"flush-element\"],[\"text\",\"\\n\"],[\"close-element\"],[\"text\",\"\\n\"]],\"locals\":[],\"named\":[],\"yields\":[],\"blocks\":[],\"hasPartials\":false}", "meta": { "moduleName": "festival-fanatic/genre/rock/template.hbs" } });
});
...
if (!runningTests) {
  require("festival-fanatic/app")["default"].create({"name":"festival-fanatic","version":"0.0.0+bc3f9694"});
}
